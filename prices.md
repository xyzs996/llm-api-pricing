...
[OpenRouter](https://openrouter.ai/models)'s public catalog on **2026-09-24**.
...
**One row here was checked against its vendor's own page, and it is wrong in every column and nearly right in the one that matters.** `deepseek/deepseek-v4-pro` is quoted from the catalog at $0.9363 in and $0.078 cache-read. Calling `deepseek-v4-pro` direct, per [DeepSeek's pricing page](https://api-docs.deepseek.com/quick_start/pricing/) read 2026-08-23, the input price is **0.7× higher** off-peak and **1.4× higher** at peak — but the cache-read price is **3.5× *lower*** at the vendor off-peak. The two errors point in opposite directions, and because 95.6% of an agent's tokens are cache reads they very nearly cancel: $0.0536 per million at the vendor off-peak against $0.1182 for the catalog row, **45% of each other**. At peak they do not cancel — $0.1073, or 0.9× the catalog row.
...
| **$0.0566** | $0.375 | $1.875 | [Gemini 3.8 Flash](https://openrouter.ai/google/gemini-3.8-flash:batch) `batch` | 1M | #4 godotgamedev |  |
...
| **$0.1131** | $0.75 | $3.75 | [Gemini 3.8 Flash](https://openrouter.ai/google/gemini-3.8-flash) | 1M | #4 godotgamedev |  |
| **$0.1153** | $0.75 | $4.50 | [Gemini 3.5 Flash](https://openrouter.ai/google/gemini-3.5-flash:batch) `batch` | 1M | #2 agenticslides(python-pptx) |  |
| **$0.1182** | $0.9363 | $1.8726 | [DeepSeek V4 Pro 0423](https://openrouter.ai/deepseek/deepseek-v4-pro) | 1M | #32 godotgamedev |  |
| **$0.1198** | $0.45 | $2.00 | [GLM 5.3](https://openrouter.ai/z-ai/glm-5.3:batch) `batch` | 1M | #7 python-pptxslides |  |
...
| **$0.2263** | $1.50 | $7.50 | [Claude Sonnet 4.6](https://openrouter.ai/anthropic/claude-sonnet-4.6:batch) `batch` | 1M | #11 mobileapps |  |
...
| **$0.3771** | $2.50 | $12.50 | [Claude Opus 4.5](https://openrouter.ai/anthropic/claude-opus-4.5:batch) `batch` | 200K | #16 mobileapps |  |
...
| **$0.4525** | $3.00 | $15.00 | [Claude Sonnet 4.6](https://openrouter.ai/anthropic/claude-sonnet-4.6) | 1M | #11 mobileapps |  |
...
| **$0.7542** | $5.00 | $25.00 | [Claude Opus 4.5](https://openrouter.ai/anthropic/claude-opus-4.5) | 200K | #16 mobileapps |  |
