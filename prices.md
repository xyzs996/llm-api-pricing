...
[OpenRouter](https://openrouter.ai/models)'s public catalog on **2026-09-10**.
...
and the spread from cheapest to dearest is 206× repriced against 333× by list price. So list price tells you
...
| --- | --- | --- | --- | --- | --- | --- |
| **$0.0073** | $0.03 | $0.12 | [Solar Pro 4](https://openrouter.ai/upstage/solar-pro4) | 524K | #31 webapps |  |
...
| **$0.1114** | $0.4875 | $1.56 | [GLM 5.2](https://openrouter.ai/z-ai/glm-5.2) | 1M | #10 agenticgamedev |  |
...
**11 of these 60 have a write-up behind them.**
