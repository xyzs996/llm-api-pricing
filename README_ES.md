# Cuánto cuestan de verdad los agentes de código con IA: 493 cifras, cada una con su frase y su fecha
...
60 modelos clasificados en alguna categoría *agents* de la Design Arena, con su **precio de lista** por millón de tokens — no es tu factura: la caché, los lotes y cada proveedor cobran distinto. Del catálogo público de OpenRouter, leído por última vez el 2026-08-24. Los tres más baratos:
