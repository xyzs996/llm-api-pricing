# Cuánto cuestan de verdad los agentes de código con IA: 338 cifras, cada una con su frase y su fecha
...
Un conjunto de datos abierto. Cada cifra publicada en 34 notas de campo — precios, porcentajes, múltiplos, recuentos de tokens y duraciones — extraída a una fila, **con la frase completa de la que salió y la fecha de publicación**.
