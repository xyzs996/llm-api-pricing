# Сколько на самом деле стоят ИИ-агенты для кода: 493 цифр, каждая со своей фразой и датой
...
59 моделей, занявших место в одной из категорий *agents* на Design Arena, с **прейскурантной ценой** за миллион токенов — это не ваш счёт: кэш, пакетный режим и каждый провайдер считают по-своему. Из открытого каталога OpenRouter, последнее чтение 2026-08-27. Три самые дешёвые:
