...
10 of the 380 figures in these field notes come from a sentence that names WorkBuddy. Each one is quoted verbatim from the write-up it appeared in, with the day that write-up went out.
...
**Or is one of the 10 above already out of date?** [Say which one](https://github.com/xyzs996/llm-api-pricing/issues/new?template=correction.yml&where=WorkBuddy&title=%5Bcorrection%5D+WorkBuddy) — the form already knows it is about WorkBuddy; you only have to say what the number is now.
