...
Every GLM model in the catalog that has been ranked in an agent category, priced three ways — list, cache read, and what the two come to at the token mix an agent actually sends. Recomputed from the source catalog on **2026-09-19**.
...
9 GLM models that have been ranked in an agent category of the Design Arena, read from [OpenRouter](https://openrouter.ai/models)'s public catalog on **2026-09-19**. Three prices per row: what the row lists, what a cache read costs, and what the two come to at the token mix a coding agent actually sends.
...
| **$0.1261** | $0.5544 | $0.103 | $1.7424 | [GLM 5.2](https://openrouter.ai/z-ai/glm-5.2) | 1M | — | #10 agenticgamedev |
...
| **$0.207** | $0.91 | $0.169 | $2.86 | [GLM 5.3](https://openrouter.ai/z-ai/glm-5.3) | 1.3M | — | #7 python-pptxslides |
