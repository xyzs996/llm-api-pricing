...
15 of the 479 figures in these field notes come from a sentence that names Claude. Each one is quoted verbatim from the write-up it appeared in, with the day that write-up went out.
...
- **10%** — “Anthropic, Google and OpenAI each charge 10% of input for a cache read.” (2026-08-24) [→](../articles/chinese-models-are-not-2x-cheaper-once-your-agent-starts.md)
...
**Or is one of the 15 above already out of date?** [Say which one](https://github.com/xyzs996/llm-api-pricing/issues/new?template=correction.yml&where=Claude&title=%5Bcorrection%5D+Claude) — the form already knows it is about Claude; you only have to say what the number is now.
