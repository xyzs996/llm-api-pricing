...
5 of the 500 figures in these field notes come from a sentence that names GPT-5. Each one is quoted verbatim from the write-up it appeared in, with the day that write-up went out.
