# Tác nhân lập trình AI thực sự tốn bao nhiêu: 559 con số, mỗi con số kèm câu gốc và ngày
...
Một bộ dữ liệu mở. Mọi con số xuất hiện trong 61 ghi chép thực đo — giá, phần trăm, bội số, số token, thời lượng — đều được tách thành một dòng, **kèm nguyên câu chứa nó và ngày công bố**.

## Hôm nay chạy agent tốn bao nhiêu

66 mô hình được xếp hạng trong một hạng mục *agents* của Design Arena, kèm **giá niêm yết** cho mỗi triệu token — không phải hóa đơn của bạn: cache, batch và từng nhà cung cấp tính khác nhau. Lấy từ danh mục công khai của OpenRouter, đọc lần cuối ngày 2026-09-20. Ba mô hình rẻ nhất:
