# Ce que coûtent réellement les agents de code IA : 408 chiffres, chacun avec sa phrase et sa date
...
Un jeu de données ouvert. Chaque chiffre publié dans 49 notes de terrain — prix, pourcentages, multiples, nombres de tokens et durées — extrait en une ligne, **avec la phrase entière dont il provient et sa date de publication**.
