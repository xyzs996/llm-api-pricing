# Ce que coûtent réellement les agents de code IA : 338 chiffres, chacun avec sa phrase et sa date
...
Un jeu de données ouvert. Chaque chiffre publié dans 34 notes de terrain — prix, pourcentages, multiples, nombres de tokens et durées — extrait en une ligne, **avec la phrase entière dont il provient et sa date de publication**.
