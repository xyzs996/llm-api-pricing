...
> 64 models · re-read from OpenRouter every day · no signup · CC BY 4.0
...
## What the agent models cost (64 models)
...
median **6.5×** (3.4×–12.6×). Read **2026-09-22**; the three cheapest *to run*:
...
[All 64 models](prices.md) · [JSON](https://cdn.jsdelivr.net/gh/xyzs996/llm-api-pricing@main/data/prices.json) · [CSV](https://cdn.jsdelivr.net/gh/xyzs996/llm-api-pricing@main/data/prices.csv)
...
64 models, 19 columns per row: list input, output and **cache-read** price per million tokens, the context window and
...
**By provider.** [Claude](providers/claude.md) (39) · [GPT-5.6](providers/gpt-5-6.md) (21) · [Gemini](providers/gemini.md) (13) · [WorkBuddy](providers/workbuddy.md) (13) · [BrowserAct](providers/browseract.md) (12) · [GLM](providers/glm.md) (12) · [Klarna](providers/klarna.md) (12) · [OpenAI](providers/openai.md) (12) · [DeepSeek](providers/deepseek.md) (8) · [Fable 5](providers/fable-5.md) (7) · [GPT-5](providers/gpt-5.md) (6) · [Codex](providers/codex.md) (5) · [ChatGPT](providers/chatgpt.md) (4) · [Kimi](providers/kimi.md) (4) — prices where there are prices, and every figure whose sentence names it, with the date.
