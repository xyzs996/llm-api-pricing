...
52 write-ups on what those bills looked like in production.
...
## The figures, as data (429 rows)

Every figure published across the 52 write-ups —
...
[All 429 rows](figures.md) — or as data:
