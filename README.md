...
> 58 models · re-read from OpenRouter every day · no signup · CC BY 4.0
...
## What the agent models cost (58 models)
...
median **6.5×** (3.5×–7.9×). Read **2026-09-08**; the three cheapest *to run*:
...
[All 58 models](prices.md) · [JSON](https://cdn.jsdelivr.net/gh/xyzs996/llm-api-pricing@main/data/prices.json) · [CSV](https://cdn.jsdelivr.net/gh/xyzs996/llm-api-pricing@main/data/prices.csv)
...
58 models, 19 columns per row: list input, output and **cache-read** price per million tokens, the context window and
