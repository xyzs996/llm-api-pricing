...
![Office Automation with Claude Code and Codex](https://cdn.jsdelivr.net/gh/xyzs996/llm-api-pricing@main/assets/cards/a/office-automation-with-claude-code-and-codex.png)
...
The 1 figures in this piece — each with the sentence it came from — are in [the figures table](../figures.md), alongside 402 more, as JSON and CSV.
...
in. **Got a better number?** [Open an issue](https://github.com/xyzs996/llm-api-pricing/issues/new?template=correction.yml&where=articles%2Foffice-automation-with-claude-code-and-codex.md&title=%5Bcorrection%5D+Office+Automation+with+Claude+Code+and+Codex) — that form knows
